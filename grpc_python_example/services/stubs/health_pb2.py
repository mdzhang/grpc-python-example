...
_HEALTHCHECKRESPONSE_SERVINGSTATUS = _descriptor.EnumDescriptor(
  name='ServingStatus',
  full_name='grpc_python_example.HealthCheckResponse.ServingStatus',
  filename=None,
  file=DESCRIPTOR,
  values=[
...
_HEALTHCHECKREQUEST = _descriptor.Descriptor(
  ...
  full_name='grpc_python_example.HealthCheckRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='service', full_name='grpc_python_example.HealthCheckRequest.service', index=0,
...
_HEALTHCHECKRESPONSE = _descriptor.Descriptor(
  ...
  full_name='grpc_python_example.HealthCheckResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='grpc_python_example.HealthCheckResponse.status', index=0,
...
HealthCheckRequest = _reflection.GeneratedProtocolMessageType('HealthCheckRequest', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:grpc_python_example.HealthCheckRequest)
  ))
...
HealthCheckResponse = _reflection.GeneratedProtocolMessageType('HealthCheckResponse', (_message.Message,), dict(
  ...
  __module__ = 'health_pb2'
  # @@protoc_insertion_point(class_scope:grpc_python_example.HealthCheckResponse)
  ))
...
def add_HealthServicer_to_server(servicer, server):
  ...
  generic_handler = grpc.method_handlers_generic_handler(
      'grpc_python_example.Health', rpc_method_handlers)
...
def beta_create_Health_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
  ...
  response_serializers = {
    ('grpc_python_example.Health', 'Check'): HealthCheckResponse.SerializeToString,
  }
  method_implementations = {
    ('grpc_python_example.Health', 'Check'): face_utilities.unary_unary_inline(servicer.Check),
  }
...
def beta_create_Health_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
  request_serializers = {
    ('grpc_python_example.Health', 'Check'): HealthCheckRequest.SerializeToString,
  }
  response_deserializers = {
    ('grpc_python_example.Health', 'Check'): HealthCheckResponse.FromString,
  }
  cardinalities = {
    'Check': cardinality.Cardinality.UNARY_UNARY,
  }
  stub_options = beta_implementations.stub_options(host=host, metadata_transformer=metadata_transformer, request_serializers=request_serializers, response_deserializers=response_deserializers, thread_pool=pool, thread_pool_size=pool_size)
  return beta_implementations.dynamic_stub(channel, 'grpc_python_example.Health', cardinalities, options=stub_options)
